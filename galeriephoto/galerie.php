...
<div id="myBtnContainer">
  <button class="btn Roboto active" onclick="filterSelection('all')"> TOUT AFFICHER </button>
  <button class="btn Roboto" onclick="filterSelection('salon')"> SALON </button>
  <button class="btn Roboto" onclick="filterSelection('cuisine')"> CUISINE </button>
  <button class="btn Roboto" onclick="filterSelection('chambre')"> CHAMBRE </button>
  <button class="btn Roboto" onclick="filterSelection('sdb')"> SALLE DE BAIN </button>
  <button class="btn Roboto" onclick="filterSelection('vers')"> VERRIÈRE SALON </button>
  <button class="btn Roboto" onclick="filterSelection('terrasse')"> TERRASSE </button>
</div>
