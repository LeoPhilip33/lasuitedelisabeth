...
<div class="margin-top">
  <h1 class="fonttitleglerie Roboto" > Conditions générales d'utilisation </h1>
  <hr class="hrtitle">
  <p class="supporttxttitre Roboto" > Conditions générales d'utilisation de notre suite</p>
</div>

<div class="flex_mentions-legales">
    <div class ="cgu">
        ...
        <div class="inter-regles">
            <p class="def-cgu">
                <span class="site-def">Nature des données collectées :</span>
            </p>

            <span class="def-cgu">Dans le cadre de l'utilisation des Sites, l'Éditeur est susceptible de collecter les catégories de données  suivantes concernant ses Utilisateurs :
            </span> <br> <br>
            Données de connexion (adressesIP,journauxd'événements...) <br> <br>
            Données de localisation (déplacements,donnéesGPS,GSM...) 
        </div>

        <div class="inter-regles">
            <p class="def-cgu">
                <span class="site-def">Agrégation des données</span>
            </p>

            <span class="def-cgu"> Agrégation avec des données non personnelles</span> <br>
            ...
            <span class="def-cgu"> Agrégation avec des données personnelles disponibles sur les comptes sociaux de l'Utilisateur </span> <br>
        ...
        <div class="inter-regles">
            <p class="def-cgu">
                <span class="site-def">Cookies</span>
            </p>

            <span class="def-cgu"> Durée de conservation des cookies</span> <br>
            ...
            <span class="def-cgu"> Finalité cookies </span> <br>
        ...
        <div class="inter-regles">
            <p class="def-cgu">
                <span class="site-def">Conservation des données techniques</span>
            </p>

            <span class="def-cgu"> Durée de conservation des données techniques </span> <br>
