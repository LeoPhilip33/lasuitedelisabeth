...
<div class="flex_mentions-legales">
    <div class ="cgu">
        ...
        <div class="inter-regles">
            <p class="def-cgu">
                <span class="site-def">ARTICLE 1 – RENSEIGNEMENTS PERSONNELS RECUEILLIS</span>
            </p>
        ...
        <div class="inter-regles">
            <p class="def-cgu">
                <span class="site-def">ARTICLE 2 - CONSENTEMENT</span>
            </p>
            ...
            Si après nous avoir donné votre consentement, vous changez d’avis et ne consentez plus à ce que nous puissions vous contacter, recueillir vos renseignements ou les divulguer, vous pouvez nous en aviser en nous contactant à leo.philip33@laposte.net ou par courrier à: lasuitedelisabeth.fr 24 Rue lucien Faure, RUE, RUE LUCIEN FAURE, Bordeaux, B, 33300, France
        ...
        <div class="inter-regles">
            <p class="def-cgu">
                <span class="site-def">ARTICLE 3 – DIVULGATION</span>
            </p>
        ...
        <div class="inter-regles">
            <p class="def-cgu">
                <span class="site-def">ARTICLE 4 – SHOPIFY</span>
            </p>
        ...
        <div class="inter-regles">
            <p class="def-cgu">
                <span class="site-def">ARTICLE 5 – SERVICES FOURNIS PAR DES TIERS</span>
            </p>
        ...
        <div class="inter-regles">
            <p class="def-cgu">
                <span class="site-def">ARTICLE 6 – SÉCURITÉ</span>
            </p>
        ...
        <div class="inter-regles">
            <p class="def-cgu">
                <span class="site-def">ARTICLE 7 – ÂGE DE CONSENTEMENT</span>
            </p>
        ...
        <div class="inter-regles">
            <p class="def-cgu">
                <span class="site-def">ARTICLE 8 – MODIFICATIONS APPORTÉES À LA PRÉSENTE POLITIQUE DE CONFIDENTIALITÉ</span>
            </p>
